...
let studentsHigherThanThree = document.getElementById("studentsHigherThan3");
let femaleStudentsAvgOfFive = document.getElementById("feStudentsAvgOf5");
let maleStudentsOver18 = document.getElementById("maleStudentsOver18");
let feStudentsAge24AvgGrades = document.getElementById("feStudentsAge24AvgGrades");
let maleStudentsWithFirstNameLetterB = document.getElementById("maleStudentsWithFirstNameLetterB");
let resultTask1 = document.getElementById("resultTask1");
let resultTask2 = document.getElementById("resultTask2");
let resultTask3 = document.getElementById("resultTask3");
let resultTask4 = document.getElementById("resultTask4")
let resultTask5 = document.getElementById("resultTask5");

studentsHigherThanThree.addEventListener('click', function () {
    let gradeHigherThanThree = students.filter(student => student.averageGrade > 3);
    resultTask1.innerHTML = "";
    let rowData1 = "";
    for (const student of gradeHigherThanThree) {
        rowData1 += `<tr>`;
        rowData1 += `<td style="border: 1px solid black;>${student.firstName}</td>`;
        rowData1 += `<td style="border: 1px solid black;>${student.lastName}</td>`;
        rowData1 += `<td style="border: 1px solid black;>${student.email}</td>`;
        rowData1 += `<td style="border: 1px solid black;>${student.gender}</td>`;
        rowData1 += `<td style="border: 1px solid black;>${student.city}</td>`;
        rowData1 += `<td style="border: 1px solid black;>${student.averageGrade}</td>`;
        rowData1 += `<td style="border: 1px solid black;>${student.age}</td>`;
        rowData1+= `</tr>`;
    }
    resultTask1.innerHTML = `${rowData1}`
})

femaleStudentsAvgOfFive.addEventListener(`click`, function(){
    let femaleStudentsGradesAvgOfFive = students
        .filter(student => student.gender === "Female" && student.averageGrade === 5)
        .map(student => student.firstName)
    resultTask2.innerHTML = "";
    resultTask2.innerHTML += `<h5>Data result: ${femaleStudentsGradesAvgOfFive}</h5>`
})

maleStudentsOver18.addEventListener('click', function(){
    let maleStudentsFromSkopje = students
    .filter(student => student.gender === "Male" && student.city === "Skopje" && student.age > 18)
    .map(student => `${student.firstName} ${student.lastName}`)
    resultTask3.innerHTML = "";
    resultTask3.innerHTML += `<h5>Data result: ${maleStudentsFromSkopje}</h5>`
})

feStudentsAge24AvgGrades.addEventListener('click', function(){
    let femaleStudentGrade = students.filter(student => student.gender === "Female" && student.age > 24)
    let femaleStudentMap = femaleStudentGrade.map(student => student.averageGrade);
    let femaleStudentReduce = femaleStudentMap.reduce((sum, student) => sum += student);
    let femaleStudentAverageGrades = femaleStudentReduce / femaleStudentGrade.length
    resultTask4.innerHTML = "";
    resultTask4.innerHTML = `<h5>Data result: ${femaleStudentAverageGrades}</h5>`
})

maleStudentsWithFirstNameLetterB.addEventListener('click', function(){
    let namesWithFirstLetterB = students.filter(student => student.firstName[0].toLowerCase() === "b" && student.averageGrade > 2);
    resultTask5.innerHTML = "";
    let rowData2 = "";
    for (const student of namesWithFirstLetterB) {
        rowData2 += `<tr>`;
        rowData2 += `<td style="border: 1px solid black;>${student.firstName}</td>`;
        rowData2 += `<td style="border: 1px solid black;>${student.lastName}</td>`;
        rowData2 += `<td style="border: 1px solid black;>${student.email}</td>`;
        rowData2 += `<td style="border: 1px solid black;>${student.gender}</td>`;
        rowData2 += `<td style="border: 1px solid black;>${student.city}</td>`;
        rowData2 += `<td style="border: 1px solid black;>${student.averageGrade}</td>`;
        rowData2 += `<td style="border: 1px solid black;>${student.age}</td>`;
        rowData2 += `</tr>`;
    }
    resultTask5.innerHTML = `${rowData2}`
})